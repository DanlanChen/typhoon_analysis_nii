...
def main():
	...
	model = conv_lstm_2(look_back,img_rows,img_cols,batch_size)
...
# 		print (file_path not exists)
	...
	equal_track_image_list = np.array(equal_track_image_list)
    	print equal_track_image_list
    	with open('test_file/equal_track_image_list.json','w') as f:
		json.dump(list(equal_track_image_list),f)
	""""
	np.random.shuffle(equal_track_image_list)
	equal_track_image_list = list(equal_track_image_list)
	equal_track_image_list = equal_track_image_list[:20]
